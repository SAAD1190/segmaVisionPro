...
class PromptGenerator:
    ...
    def __init__(self, image_directory="./data/", images_extensions=['jpg', 'jpeg', 'png']):
        # Initialize models separately for BLIP and the others
        self.models = {
            ...
            "blip2": VisionEncoderDecoderModel.from_pretrained("Salesforce/blip2").to(device),
        ...
        # Image processors and tokenizers for each model
        self.processors = {
            ...
            "blip2": ViTImageProcessor.from_pretrained("Salesforce/blip2"),
        ...
        self.tokenizers = {
            "blip": None,  # BlipProcessor handles decoding
            "vit_gpt2": AutoTokenizer.from_pretrained("nlpconnect/vit-gpt2-image-captioning"),
            "blip2": AutoTokenizer.from_pretrained("Salesforce/blip2"),
