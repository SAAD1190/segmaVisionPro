...
class PromptGenerator:
    ...
    def __init__(self, image_directory="./data/", images_extensions=['jpg', 'jpeg', 'png'], models_to_use=None):
        # Initialize available models (SimVLM removed)
        ...
        # Initialize the processors and models only for selected ones (SimVLM removed)
        self.models = {
            ...
            "vilt": ViltForImageAndTextRetrieval.from_pretrained("dandelin/vilt-b32-finetuned-coco").to(device)
        }
        ...
        self.processors = {
            ...
            "vilt": ViltProcessor.from_pretrained("dandelin/vilt-b32-finetuned-coco")
        }
...
# Example usage:
# To use all models (without SimVLM):
