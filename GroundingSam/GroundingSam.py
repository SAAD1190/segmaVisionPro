...
GROUNDING_DINO_CHECKPOINT_PATH = "/content/segmaVisionPro/weights/groundingdino_swint_ogc.pth"
...
SAM_CHECKPOINT_PATH = "/content/segmaVisionPro/weights/sam_vit_h_4b8939.pth"
